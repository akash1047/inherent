...
| `PATCH` | `/chunks/{document_id}/{chunk_index}?workspace_id=` | yes | Edit a chunk (updates PG + re-embeds in Weaviate). 404 if `document_id` isn't owned by `workspace_id` (#134) |
