...
| `EMBEDDING_MAX_CONCURRENCY` | `2` | In-flight TEI batch POSTs per `embed_texts` call (#231 phase 1). Product with `TEMPORAL_MAX_CONCURRENT_ACTIVITIES` is the TEI in-flight cap under bulk upload — raise carefully |
